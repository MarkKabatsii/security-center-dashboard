...
const RuleManagement: React.FC = () => {
    ...
    const [ruleForm, setRuleForm] = useState<Omit<Rule, 'id'>>({ name: '', type: '', action: 'Block' });
    ...
    const handleAddRuleClick = () => {
            setEditingRule(null);
            setRuleForm({ name: '', type: '', action: 'Block' });
            setFormErrors({});
            setIsModalOpen(true);
        };
    ...
    const handleEditRuleClick = (rule: Rule) => {
            setEditingRule(rule);
            setRuleForm({ name: rule.name, type: rule.type, action: rule.action });
            setFormErrors({});
            setIsModalOpen(true);
        };
