// src/pages/client/ErrorBlockedPage.tsx
import React from 'react';
import { useLocation, useNavigate } from 'react-router-dom';
import Button from '../../components/ui/Button'; // Переконайтеся, що шлях правильний
...
const ErrorBlockedPage: React.FC = () => {
    ...
    return (
        <div className="flex flex-col items-center justify-center min-h-screen bg-light-bg dark:bg-dark-bg text-light-text dark:text-dark-text p-4">
            ...
            <h1 className="text-3xl font-bold text-light-error dark:text-dark-error mb-4 text-center">Request Blocked!</h1>
